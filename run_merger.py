...
xyz_A, v_xyz_A = initial_plummer_positions(npoints, M=M_A, seed=798632, radius=r_A, x_pos=-1.2*r_A.value, x_vel=-20, y_vel=0)
xyz_B, v_xyz_B = initial_plummer_positions(npoints, M=M_B, seed=798632, radius=r_B, x_pos=1.2*r_B.value, x_vel=20, y_vel=0)
