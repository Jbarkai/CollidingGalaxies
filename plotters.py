...
def plot_init_vels(A_xyz, B_xyz, A_v_xyz, B_v_xyz, lim=35):
    fig,axes = plt.subplots(ncols=3, figsize=(15,5))
    axes[0].quiver(A_xyz[0], A_xyz[1], A_v_xyz[0], A_v_xyz[1], color="green", label="Galaxy A")
    axes[0].quiver(B_xyz[0], B_xyz[1], B_v_xyz[0], B_v_xyz[1], color="maroon", label="Galaxy B")
    ...
    axes[0].set_xlabel('x [kpc]')
    axes[0].set_ylabel('y [kpc]')
    axes[1].quiver(A_xyz[0], A_xyz[2], A_v_xyz[0], A_v_xyz[2], color="green", label="Galaxy A")
    axes[1].quiver(B_xyz[0], B_xyz[2], B_v_xyz[0], B_v_xyz[2], color="maroon", label="Galaxy B")
    ...
    axes[1].set_xlabel('x [kpc]')
    axes[1].set_ylabel('z [kpc]')
    axes[2].quiver(A_xyz[1], A_xyz[2], A_v_xyz[1], A_v_xyz[2], color="green", label="Galaxy A")
    axes[2].quiver(B_xyz[1], B_xyz[2], B_v_xyz[1], B_v_xyz[2], color="maroon", label="Galaxy B")
